...
import userProfileRoutes from './client-routes/userProfile.js';
import userChatRoleRoutes from './client-routes/userChatRole.js';
import clientChatRoutes from './client-routes/chat.js';
import clientStoriesRoutes from './client-routes/stories.js';
import userStoriesRoutes from './client-routes/userStories.js';
import userCharactersRoutes from './client-routes/userCharacters.js';
...
import storiesRoutes from './admin-routes/stories.js';
...
app.use('/api/stories', clientStoriesRoutes);

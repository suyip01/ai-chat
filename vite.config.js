    ...
    rollupOptions: {
      output: {
        ...
        manualChunks(id) {
          ...
          if (id.includes('/src/user/pages/Chat') || id.includes('/src/user/components/Chat')) return 'user-chat'
          if (id.includes('/src/user/pages/Story')) return 'user-story'
          if (id.includes('/src/user/pages/CharacterProfile')) return 'user-profile'
          if (id.includes('/src/user/pages/MePage')) return 'user-me'
          if (id.includes('/src/user/pages/Login')) return 'user-login'
          if (id.includes('/src/user/pages/CreateCharacter')) return 'user-create-character'
          if (id.includes('/src/user/pages/CreateStory')) return 'user-create-story'

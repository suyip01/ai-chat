      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-8 space-y-6">
          <div className="solid-card p-8 rounded-3xl space-y-4">
            <h3 className="font-cute text-lg text-purple-900 flex items-center gap-2 mb-2"><span className="w-1.5 h-4 bg-yellow-400 rounded-full"></span> 角色类型设置</h3>
            <div className="flex flex-wrap gap-3">
              {['原创角色', '二次创作', '其他'].map((t) => (
                <button
                  key={t}
                  onClick={() => setFormData({ ...formData, characterType: t })}
                  className={`px-6 py-3 rounded-2xl text-sm font-bold transition-all ${formData.characterType === t ? 'bg-purple-500 text-white shadow-md' : 'bg-white text-gray-500 hover:text-purple-600'}`}
                >
                  {t}
                </button>
              ))}
          ...
          <div className="solid-card p-8 rounded-3xl space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-xs font-bold text-purple-800 mb-2">年龄</label>
              ...
              <div>
                <label className="block text-xs font-bold text-purple-800 mb-2">职业</label>
          ...
          <div className="solid-card p-8 rounded-3xl relative overflow-visible bg-gradient-to-r from-purple-50 to-indigo-50 border-purple-100">
            ...
            <p className="text-xs text-purple-400 mt-2 ml-1">* 将根据上方输出的提示词，进行二次生成不带场景描述的提示词。</p>
            <div className="mt-4 relative">

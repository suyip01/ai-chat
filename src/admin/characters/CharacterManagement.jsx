        ...
        {characterList.map((char) => (
          <div key={char.id} className="relative">
            <div className="glass-card p-5 rounded-3xl hover:shadow-xl transition-all group relative overflow-hidden">
              ...
              <div className="bg-white/50 rounded-xl p-3 mb-4 text-xs text-gray-500">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="font-bold text-purple-600">标准：{char.templateName || '-'}</div>
                    <div className="font-bold text-purple-600">场景：{char.sceneTemplateName || '-'}</div>
                  </div>
                </div>
              </div>

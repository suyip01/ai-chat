...
export const ChatDetail: React.FC<ChatDetailProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-primary-50 z-50">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 no-scrollbar bg-primary-50">
      ...
      <div className="bg-white p-3 pb-3 border-t border-slate-100 shadow-[0_-4px_20px_rgba(0,0,0,0.02)] pb-[env(safe-area-inset-bottom)] mb-3">

...
export const CharacterProfile: React.FC<CharacterProfileProps> = ({ character, onBack, onStartChat, isFromChat = false }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-primary-50">
      <div className="mx-auto w-full max-w-md h-full flex flex-col bg-white shadow-2xl rounded-none md:rounded-3xl md:overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar relative pb-24">
        ...
        <div className="relative w-full h-[55vh]">
          ...
          <button 
            onClick={onBack}
            className="absolute top-4 left-4 z-20 w-10 h-10 bg-black/20 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-black/30 transition-all"
          >
            <ArrowLeft size={24} />
          </button>
